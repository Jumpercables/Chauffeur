...
namespace Chauffeur.Jenkins.System
{
    ...
    public class NetworkDrive : IDisposable
    {
        ...
        /// </summary>
        private enum ResourceDisplayOptions
        {
            /// <summary>
            ///     The generic
            /// </summary>
        ...
        private NetworkDrive(NetworkResource resource, NetworkCredential credentials)
        {
            _Resource = resource;
        ...
        /// <param name="credentials">The credentials.</param>
        /// <returns></returns>
        public static NetworkDrive Map(string path, NetworkCredential credentials)
        {
